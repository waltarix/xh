        ...
        xh)
            ...
            case "${prev}" in
                ...
                --pretty)
                    ...
                    ;;
                --style)
                    COMPREPLY=($(compgen -W "auto solarized monokai fruity myColor" -- "${cur}"))
                    return 0
                    ;;
                -s)
                    COMPREPLY=($(compgen -W "auto solarized monokai fruity myColor" -- "${cur}"))
